...
def snapshot_linear_cache(cache):
    ...
    Returns a dict: {layer_idx: (conv_clone, recurrent_clone, conv_init, recur_init)}.
    """
    ...
    for idx, layer in enumerate(layers):
        if isinstance(layer, LinearAttentionCacheLayerMixin):
            # conv_states / recurrent_states are dict[int, Tensor|None]
            conv_snap = {}
            ...
            # conv_init / recur_init may also be dicts
